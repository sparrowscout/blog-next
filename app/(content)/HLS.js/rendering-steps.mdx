...
date: '2025-01-01'
excerpt: '✏️ <video> 태그로 HLS.js를 사용했을 때 브라우저에 영상을 렌더링하기 위해서 HLS가 하는 일 정리'
---
...
# MSE가 파싱할 수 있게 segment transmux하기
...
# 사용자의 네트워크 bandwidth를 의식하면서 위의 단계를 반복해서 영상을 재생하기!
